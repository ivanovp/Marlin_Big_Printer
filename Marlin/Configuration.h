...
#define STRING_SPLASH_LINE2 __DATE__ " " __TIME__ //WEBSITE_URL         // will be shown during bootup in line 2
...
#define MACHINE_UUID "32012df5-95b4-4127-8953-1f1d4cd80367"
...
#define PID_MAX 200 //BANG_MAX // Limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Peter's Big Printer with dual head
  #define DEFAULT_Kp 8.84
  #define DEFAULT_Ki 0.60
  #define DEFAULT_Kd 32.74
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 63.546, 62.99, 1066.67, 1020 }
 ...
 */
#define DEFAULT_MAX_FEEDRATE          { 200, 233, 5, 25 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1500, 1500, 10, 1000 }
...
#define Z_MAX_POS 300 //280 for diamond head
...
#define Z_PROBE_END_SCRIPT "G0 Z0.5 F12000"
